...
function SettingsPage() {
  ...
  return (
    <div className="space-y-6 max-w-2xl">
            ...
            <Dialog open={pwOpen} onOpenChange={setPwOpen}>
              ...
              <DialogContent>
                ...
                <div className="space-y-3">
                  <div className="space-y-1"><Label>{t("dashboard.settings.currentPw")}</Label><Input type="password" value={currentPw} onChange={(e) => setCurrentPw(e.target.value)} /></div>
      ...
      <Card>
        <CardHeader><CardTitle className="text-base">{t("dashboard.settings.notifications")}</CardTitle></CardHeader>
        <CardContent>
