...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      { title: "Contact San Brothers — Kigali" },
      {
        name: "description",
        content:
          "Contact San Brothers in Kigali for visas, accounting, translation, and consultancy.",
      },
    ],
  }),
  component: Contact,
...
function Contact() {
  ...
  return (
    <PublicLayout>
      ...
      <section className="relative overflow-hidden border-b border-border bg-linear-to-br from-primary/10 via-background to-visa/10">
        <ParallaxLayer
          speed={-0.2}
          aria-hidden
        ...
        <ParallaxLayer
          speed={0.15}
          aria-hidden
          className="pointer-events-none absolute -bottom-32 left-0 h-[24rem] w-[24rem]"
        >
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-20 text-center md:px-6">
          <p className="text-xs font-bold uppercase tracking-[0.22em] text-primary">
            Contact San Brothers
          </p>
          <h1 className="mt-4 text-5xl font-black tracking-tight md:text-6xl">Let's Talk</h1>
          <p className="mx-auto mt-5 max-w-2xl text-lg text-muted-foreground">
            Whether you need a visa, accounting help, translation, or business support — we're one
            message away.
          </p>
              ...
              <form onSubmit={onSubmit} className="mt-7 grid gap-5">
                ...
                <div className="grid gap-2">
                  ...
                  >
                    ...
                    <SelectContent>
                      <SelectItem value="visa">Visa & Permits Inquiry</SelectItem>
                      <SelectItem value="accounting">Accounting Services</SelectItem>
                      <SelectItem value="translation">Translation Request</SelectItem>
                      <SelectItem value="consultancy">Business Consultancy</SelectItem>
                      <SelectItem value="interpreter">Live Interpreter Booking</SelectItem>
                ...
                <Magnetic strength={12} className="block w-full">
              ...
              <div className="mt-7 space-y-5 text-sm">
                {[
                  ...
                  <div key={String(text)} className="flex items-start gap-3">
                    ...
                    <span className="pt-2">{String(text)}</span>
                  </div>
                ))}
              </div>
              <div className="my-7 border-t border-border" />
              <h3 className="font-semibold">Prefer a faster reply?</h3>
              <div className="mt-4 grid gap-3">
                <Magnetic strength={12} className="block">
                  <Button
                ...
                <Magnetic strength={10} className="block">
                  <Button variant="outline" className="w-full" asChild>
                    <a href="mailto:sanbrothersgroup@gmail.com">
                      <Mail /> Email San Brothers
                    </a>
                  </Button>
                </Magnetic>
              </div>
              <p className="mt-7 text-sm text-muted-foreground">
                We respond in: 🇷🇼 RW · 🇬🇧 EN · 🇨🇳 中文 · 🇫🇷 FR · 🇸🇦 AR
              </p>
            </CardContent>
          </Card>
        </div>
      ...
      <section className="bg-muted/45 py-16">
        <div className="mx-auto max-w-7xl px-4 md:px-6">
          <div className="mb-7">
            <p className="text-xs font-bold uppercase tracking-[0.2em] text-primary">Our office</p>
            <h2 className="mt-2 text-3xl font-bold">Find Us in Kigali</h2>
          </div>
          <Card className="overflow-hidden">
            <CardContent className="p-0">
              ...
              />
              <div className="grid gap-3 p-6 sm:grid-cols-[1fr_auto] sm:items-center">
                <div>
                  <p className="font-semibold">Florida House, 2nd Floor</p>
                  <p className="text-sm text-muted-foreground">KN 70 Street, Kigali, Rwanda</p>
                </div>
                <Button variant="outline" asChild>
                  <a
                    href="https://maps.google.com/?q=KN+70+Street+Kigali+Rwanda"
                    target="_blank"
                    rel="noreferrer"
                  >
      ...
      <section className="mx-auto max-w-4xl px-4 py-20 md:px-6">
        <div className="text-center">
          ...
          <p className="mt-3 text-muted-foreground">A few quick answers before you get in touch.</p>
        </div>
        <div className="mt-8 divide-y divide-border rounded-2xl border border-border bg-card px-6">
          {[
            [
              "How quickly can you process a visa application?",
              "Most tourist visas take 3–7 business days. We keep you updated at every step.",
            ],
            [
              "Do I need to visit your office?",
              "No. Everything can be handled digitally through our platform.",
            ],
            [
              "Which languages do you work in?",
              "English, Chinese (Mandarin), Kinyarwanda, French, and Arabic.",
            ],
          ].map(([question, answer]) => (
      ...
      <CtaBanner
        title="Ready to get started instead?"
        subtitle="Create a free account and apply for any service in minutes."
