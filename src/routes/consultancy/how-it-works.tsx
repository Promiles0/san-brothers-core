...
export const Route = createFileRoute("/consultancy/how-it-works")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "From first consultation to delivered solution in three simple steps." },
    ],
  }),
...
const STEPS = [
  { title: "Choose your consultation type", desc: "Tell us what you need: company registration, business planning, trade & investment, document processing, or ongoing administrative support." },
  { title: "Meet with our expert", desc: "Within one business day we match you with the right specialist. Free 30-minute discovery call to scope the work and agree on price." },
  { title: "Get your solution", desc: "Clear deliverables, milestone updates inside your dashboard, and direct messaging with your case manager until completion." },
];
