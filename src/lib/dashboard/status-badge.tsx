...
const colorMap: Record<string, string> = {
  ...
  submitted_to_authority: "bg-purple-500/15 text-purple-700 dark:text-purple-400 border-purple-500/30",
...
export function StatusBadge({
  ...
  return (
    <Badge
      variant="outline"
      className={cn("border font-medium capitalize", colorMap[status] ?? "bg-muted text-muted-foreground", className)}
    >
