...
export const requiredDocsBySlug: Record<string, string[]> = {
  "visa-student": ["Valid passport", "Admission letter", "Financial proof", "Recent photo", "Academic records"],
  "visa-tourist": ["Valid passport", "Travel itinerary", "Hotel booking", "Bank statements", "Recent photo"],
  "visa-business": ["Valid passport", "Invitation letter", "Company registration", "Bank statements", "Travel insurance"],
  "visa-work": ["Valid passport", "Signed employment contract", "Health certificate", "Police clearance", "Education credentials"],
  "visa-consultation": ["Valid passport (optional)"],
  "tax-filing": ["Last year's tax return", "Income records", "Expense records", "Bank statements", "TIN certificate"],
  "tax-preparation": ["Last year's tax return", "Income records", "Expense records", "Bank statements", "TIN certificate"],
  ...
  "company-registration": ["Founder ID/passport", "Proposed company name list", "Articles of association draft"],
